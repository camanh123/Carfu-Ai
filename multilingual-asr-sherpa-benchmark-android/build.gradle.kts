...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 29
        versionCode = 3
        versionName = "0.3b1.2-sherpa-performance-memory"
        ...
        buildConfigField("String", "PHASE_NAME", "\"3B.1.2\"")
...
android.applicationVariants.configureEach {
    outputs.configureEach {
        val fileName = if (buildType.name == "debug") {
            "carfu-sherpa-zipformer-vi-benchmark-p3b1-2.apk"
        } else {
            "carfu-sherpa-zipformer-vi-benchmark-p3b1-2-${buildType.name}.apk"
        }
...
tasks.register<Copy>("syncDiagnosticApk") {
    ...
    rename { "carfu-sherpa-zipformer-vi-benchmark-p3b1-2.apk" }
}
