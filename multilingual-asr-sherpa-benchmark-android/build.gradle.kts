...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 29
        versionCode = 1
        versionName = "0.3b1-sherpa-zipformer-vi"
        ...
        buildConfigField("String", "PHASE_NAME", "\"3B.1\"")
...
android.applicationVariants.configureEach {
    outputs.configureEach {
        val fileName = if (buildType.name == "debug") {
            "carfu-sherpa-zipformer-vi-benchmark.apk"
        } else {
            "carfu-sherpa-zipformer-vi-benchmark-${buildType.name}.apk"
        }
...
tasks.register<Copy>("syncDiagnosticApk") {
    ...
    rename { "carfu-sherpa-zipformer-vi-benchmark.apk" }
}
