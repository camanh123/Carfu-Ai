...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 29
        versionCode = 2
        versionName = "0.3b1.1-sherpa-stability"
        ...
        buildConfigField("String", "PHASE_NAME", "\"3B.1.1\"")
...
android.applicationVariants.configureEach {
    outputs.configureEach {
        val fileName = if (buildType.name == "debug") {
            "carfu-sherpa-zipformer-vi-benchmark-p3b1-1.apk"
        } else {
            "carfu-sherpa-zipformer-vi-benchmark-p3b1-1-${buildType.name}.apk"
        }
...
tasks.register<Copy>("syncDiagnosticApk") {
    ...
    rename { "carfu-sherpa-zipformer-vi-benchmark-p3b1-1.apk" }
}
